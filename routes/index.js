...
router.get('/', (req, res) => {
    ...
    let query = "SELECT ID, Name, Place, Logo FROM tbl_favourite";
    ...
    sql.query(query, (err, result) => {
        ...
        res.render('home', { festivals: result });
    })
})
...
router.get('/users/:id', (req, res) => {
    ...
    let query = `SELECT Video, Info, Stage FROM tbl_favourite WHERE favID="${req.params.id}"`;
